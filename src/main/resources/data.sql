...
INSERT INTO recipe(id, name, description, like_counter, recipe_category_id, img) VALUES
(1, 'SAŁATKA Z MANGO I AWOKADO', 'Umytą i osuszoną rukolę ułożyć w salaterkach. Dodać obrane i pokrojone w kostkę mango, awokado oraz ser. Dodać połamane orzechy włoskie i wyłuskane ziarna granatu.', 25, 2, '/salatka_z_mango_awokado_01.jpg'),
(2, 'MAKARON Z GRZYBAMI', 'Grzyby oczyścić, umyć, osuszyć i pokroić w plasterki. Mrożone grzyby wyłożyć na sitko i kilka razy przelać ciepłą wodą w celu ich rozmrożenia, odcedzić i pokroić na plasterki.', 10, 3, '/makaron_z_grzybami_01_0.jpg'),
(3, 'GULASZ Z INDYKA Z KURKAMI', 'Filet pokroić w kostkę ok. 1,5 cm. Doprawić solą, pieprzem i obtoczyć w 1 łyżce mąki pszennej.', 2, 1, '/gulasz_z_indyka_z_kurkami_01.jpg'),
(4, 'POLEWA CZEKOLADOWA', 'Śmietankę umieścić w rondelku i zagotować (z dodatkiem cukru jeśli go używamy).', 0, 4, '/polewa_czekoladowa_01.jpg'),
(5, 'CIASTO ZE ŚLIWKAMI I BUDYNIEM', 'Śliwki pokroić na ćwiartki, usunąć pestki. Mąkę wymieszać z proszkiem do pieczenia i cukrem. Dodać pokrojone na kawałeczki zimne masło lub margarynę i rozcierać palcami na drobną kruszonkę, lub miksować składnki mieszadłem miksera planetarnego, ewentualnie siekać składniki na stolnicy', 32, 4, '/ciasto_ze_sliwkami_budyniem_01.jpg');
